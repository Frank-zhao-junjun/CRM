...
| V5.2 | 2026-04-15 | **服务工单管理**：工单列表、详情、评论、状态管理 |
| V6.0 | 2026-04-17 | **工作流自动化引擎**：可视化工作流设计器、触发器类型、节点配置、执行日志 |
| V7.0 | 2026-04-17 | **合同回款管理增强**：回款记录CRUD、自动计算回款状态、逾期检测、回款进度条、合同列表金额统计、客户筛选器、预计回款日期 |
