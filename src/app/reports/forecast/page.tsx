...
import { Download, TrendingUp, TrendingDown, Target, DollarSign, BarChart3, PieChart } from 'lucide-react';
...
export default function ForecastReportPage() {
  ...
  const actualRevenue = wonOpps.reduce((sum, opp) => sum + opp.value, 0);
