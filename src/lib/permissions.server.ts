...
export type PermissionName = 
  ...
  | 'contracts.view' | 'contracts.create' | 'contracts.update' | 'contracts.delete' | 'contracts.sign'
  ...
  | 'payment_plans.view' | 'payment_plans.create' | 'payment_plans.update' | 'payment_plans.delete'
  | 'products.view' | 'products.create' | 'products.update' | 'products.delete'
  | 'tasks.view' | 'tasks.create' | 'tasks.update' | 'tasks.delete'
  | 'reports.view' | 'reports.export' | 'reports.team'
  | 'settings.view' | 'settings.update' | 'settings.fields' | 'settings.workflows' | 'settings.roles'
...
export const defaultPermissions: Array<{
  ...
  { name: 'contracts.update', label: '编辑合同', description: '编辑合同信息', category: 'contracts' },
  ...
  { name: 'invoices.update', label: '编辑发票', description: '编辑发票信息', category: 'invoices' },
  ...
  { name: 'orders.update', label: '编辑订单', description: '编辑订单信息', category: 'orders' },
  ...
  { name: 'quotes.update', label: '编辑报价', description: '编辑报价信息', category: 'quotes' },
  ...
  { name: 'settings.update', label: '编辑设置', description: '编辑系统设置', category: 'settings' },
  ...
  { name: 'users.update', label: '编辑用户', description: '编辑用户信息', category: 'users' },
